...
RSpec.describe OverScorer, type: :service do
  ...
  def total_for(value, scope: :game)
    create_total(game: game, kind: :over, value: value, scope: scope)
  end

  it "wins when the combined score is above the total" do
  ...
  it "loses when the combined score is below the total" do
